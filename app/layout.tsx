...
const TITLE =
  "MARUS GROUP — стекло и профиль к приёмке без новых рисков для застройщика";
const DESCRIPTION =
  "Убираем дефекты по стеклу и алюминиевому профилю на финальной стадии: регламент из 12 шагов, защита отделки, понятная сдача с актом. Ответ по заявке — до 1 рабочего дня. Москва и МО, с 2008 года.";
