      ...
      <div className="container">
        <div className="max-w-3xl">
          ...
          <p className="section-subtitle">
            Прямой контакт с инженером по объекту: оценка, выезд, КП. Первый
            ответ — до 1 рабочего дня; по срочным срокам сдачи — приоритет при
            наличии бригад.
          </p>
        </div>
          ...
          <div className="card p-6 sm:p-8">
            ...
            <div className="mt-6 rounded-xl bg-surface-subtle p-4 ring-1 ring-inset ring-line">
              <p className="text-sm text-ink-muted">
                Реквизиты для договора и тендерной документации — по запросу.
                Работаем по вашей форме договора; NDA — в день обращения. График
                бригад на финальную стадию планируется заранее: чем раньше
                заявка, тем проще попасть в ваш дедлайн без наценки за «вчера».
              </p>
            </div>
          </div>
        </div>
