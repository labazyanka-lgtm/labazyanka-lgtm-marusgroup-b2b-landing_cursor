...
const COLUMNS = [
  ...
  },
  {
    ...
    items: [
      ...
      "гарантийные условия согласуются в договоре",
      "условия зависят от вида работ и характера дефекта",
    ],
  },
  {
    icon: AlertCircle,
      ...
      <div className="container">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 section-title text-balance">
            Работаем официально и заранее фиксируем условия выполнения работ
          </h2>
          <p className="section-subtitle">
            Перед началом работ согласуем объём, зоны ответственности,
            ограничения по дефектам и порядок сдачи результата.
          </p>
        </div>
        ...
        <div className="mt-10">
          <a href="#estimate" className="btn-secondary">
            Запросить документы для согласования подрядчика
          </a>
        </div>
      </div>
    </section>
