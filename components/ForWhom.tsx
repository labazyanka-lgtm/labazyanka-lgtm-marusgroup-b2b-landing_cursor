      ...
      <div className="container">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 section-title text-balance">
            Работаем с командами застройщика, которые отвечают за качество
            объекта
          </h2>
          <p className="section-subtitle">
            Подключаемся на этапе устранения замечаний перед приёмкой, сдачей
            объекта или передачей готовых помещений покупателям.
          </p>
        </div>
