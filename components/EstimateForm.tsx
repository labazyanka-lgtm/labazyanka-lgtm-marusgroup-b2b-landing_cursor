          ...
          <div className="grid lg:grid-cols-12">
            <aside className="lg:col-span-5 bg-gradient-to-br from-accent-700 to-accent-900 p-8 sm:p-10 text-white">
              ...
              <p className="mt-4 text-white/85 max-w-md">
                Один запрос — три результата: понимание, можно ли закрыть
                дефект без замены; следующий шаг (фото / выезд / КП); слот в
                графике под ваш срок сдачи. Ответственный специалист отвечает до
                1 рабочего дня.
              </p>
              ...
              <ul className="mt-8 space-y-3 text-sm text-white/90">
                {[
                  {
                    icon: Camera,
                    text: "Первичный разбор по фото — без оплаты и без обязательств с вашей стороны",
                  },
                  {
                    icon: CalendarDays,
                    text: "Выезд на дефектовку — согласуем доступ и время так, чтобы не парализовать объект",
                  },
                  {
                    icon: FileText,
                    text: "КП с разделением «восстановление / замена» — видите полную картину до подписания договора",
                  },
                ].map((row) => (
              ...
              <div className="mt-10 border-t border-white/15 pt-6 text-sm text-white/80">
                <p className="font-medium text-white/95">
                  Срочно по сроку сдачи? Позвоните — оперативно согласуем
                  приоритет.
                </p>
                <p className="mt-3">
                  <a
              ...
              {submitted ? (
                <div className="flex h-full flex-col items-start justify-center">
                  ...
                  <p className="mt-2 text-ink-muted max-w-md">
                    ...
                    Если сдача «горит» — отметьте это в комментарии: поднимем
                    приоритет в очереди. При необходимости запросим уточнения и
                    согласуем фото, выезд или КП.
                  </p>
                </div>
              ) : (
                <form
